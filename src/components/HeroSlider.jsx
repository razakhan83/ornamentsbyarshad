...
export default function HeroSlider({ slides = [] }) {
  ...
  if (resolvedSlides.length === 0) {
    return (
      <section className="relative w-full overflow-hidden bg-transparent px-3 sm:px-5 md:px-6 lg:px-8 pt-2.5 sm:pt-3.5 md:pt-4 pb-2">
        <div className="relative min-h-[500px] md:min-h-[600px] lg:min-h-[680px] w-full flex items-center justify-center overflow-hidden rounded-sm sm:rounded-sm bg-[#121212]">
          <Image
  ...
  return (
    ...
    >
      <div className="relative h-[58vh] min-h-[400px] w-full overflow-hidden rounded-sm sm:rounded-sm md:h-[540px] lg:h-[680px] bg-transparent">
