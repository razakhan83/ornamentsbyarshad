            ...
            {PRICE_PILLS.map((pill) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'h-8 px-3 rounded-none text-xs uppercase tracking-wider font-semibold transition-all duration-200 cursor-pointer border select-none',
                    isSelected
        ...
        <div className="flex items-center gap-3 ml-auto shrink-0">
          <div className="flex items-center gap-1.5">
            ...
            <Select value={currentSort} onValueChange={(val) => handleChange('sort', val)}>
              <SelectTrigger className="h-8.5 w-auto border border-[#E8E5DF] bg-white px-3 text-xs sm:text-xs uppercase tracking-wider font-semibold focus:ring-1 focus:ring-[#121212] hover:bg-[#FAF9F6] rounded-none">
                <SelectValue placeholder="Newest First" />
              </SelectTrigger>
              <SelectContent align="end" className="rounded-none border border-[#E8E5DF] bg-white">
          ...
          <div className="flex items-center gap-0.5 border-l border-[#E8E5DF] pl-2">
            <button
              ...
              className={`flex h-8 w-8 items-center justify-center rounded-none transition-colors cursor-pointer ${layout === '1col' ? 'bg-[#121212] text-white' : 'text-[#737373] hover:text-[#121212] hover:bg-neutral-100'}`}
            ...
            <button
              ...
              className={`flex h-8 w-8 items-center justify-center rounded-none transition-colors cursor-pointer ${layout === '2col' || !layout || layout === 'grid4' ? 'bg-[#121212] text-white' : 'text-[#737373] hover:text-[#121212] hover:bg-neutral-100'}`}
