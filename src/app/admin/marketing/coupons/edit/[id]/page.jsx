    ...
    <div className="flex flex-col gap-6 w-full max-w-5xl mx-auto p-4 md:p-6 pb-24">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold tracking-tight">Edit Coupon Code</h1>
          <p className="text-muted-foreground text-sm">Update the configuration of this discount code.</p>
        </div>
      </div>
